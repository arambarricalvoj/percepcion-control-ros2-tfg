...
class GidatzeProbaWrapper(Node):
    ...
    ##########################################################################
    def aruco_identifikatu(self, argazkia):
        argazkiaBGR8 = self.bridge.imgmsg_to_cv2(argazkia.image, desired_encoding="bgr8")
        markerCorners, markerIds, rejectedCandidates = self.detector.detectMarkers(argazkiaBGR8)
    ...
    def arucoBilatu(self, goal_handle):
        ...
        self.aruco_identifikatu(argazkia)
        ...
        result.amaierako_angelua = 88.8
        result.hasierako_angelua = 99.9
        result.bira_kopurua = 1
